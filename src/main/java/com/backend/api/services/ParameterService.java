...
public class ParameterService extends CrudService<Parameter, ParameterDTO> {
	...
	public Parameter fromDTO(ParameterDTO dto) {
		...
		final Parameter obj = new Parameter(null, dto.getChave(), dto.getValor(), dto.getNote());
		return obj;
	}
	...
	public ParameterDTO toDTO(Parameter obj) {
		...
		final ParameterDTO dto = new ParameterDTO(obj.getChave(), obj.getValor(), obj.getNote());
		return dto;
	}
